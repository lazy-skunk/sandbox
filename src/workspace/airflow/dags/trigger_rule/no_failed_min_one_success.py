...
@dag(
    dag_id="NONE_FAILED_MIN_ONE_SUCCESS",
...
def build_none_failed_min_one_success_dag() -> None:  # noqa: C901
    @task_group()
    def prepare_party() -> None:
        ...
        def check_guest_count() -> None:
            ...
            none_failed_min_one_success = EmptyOperator(
                task_id="none_failed_min_one_success",
                trigger_rule=TriggerRule.NONE_FAILED_MIN_ONE_SUCCESS,
            )
            (
                choose_party_plan()
                >> [no_guests, regular_party, too_many_guests]
...
build_none_failed_min_one_success_dag()
